...
export declare type MessagesAddChatUserResponse = {};
/**
...
export declare type MessagesAllowMessagesFromGroupResponse = 1;
/**
 * messages.createChat
 *
...
export declare type MessagesDeleteResponse = MessagesDeleteFullResponseItem[];
/**
...
export declare type MessagesDeleteReactionResponse = 0 | 1;
/**
...
export declare type MessagesDenyMessagesFromGroupResponse = 1;
/**
 * messages.edit
 *
 * Edits the message.
 ...
 * Result
 */
export declare type MessagesEditResponse = 0 | 1;
/**
 * messages.editChat
 *
...
export declare type MessagesEditChatResponse = 1;
/**
...
export declare type MessagesGetChatResponse = MessagesChat;
export declare type MessagesGetChatFieldsResponse = MessagesChatFull;
export declare type MessagesGetChatChatIdsResponse = MessagesChat[];
export declare type MessagesGetChatChatIdsFieldsResponse = MessagesChatFull[];
/**
...
export declare type MessagesGetConversationMembersResponse = MessagesGetConversationMembers;
/**
...
export interface MessagesGetHistoryAttachmentsParams {
     ...
     */
    media_type?: 'app_action_games' | 'app_action_mini_apps' | 'audio' | 'audio_message' | 'clip' | 'doc' | 'graffiti' | 'link' | 'market' | 'photo' | 'share' | 'video' | 'wall';
    /**
...
export declare type MessagesGetLastActivityResponse = MessagesLastActivity;
/**
...
export declare type MessagesGetLongPollServerResponse = MessagesLongpollParams;
/**
...
export declare type MessagesMarkAsAnsweredConversationResponse = 1;
/**
...
export declare type MessagesMarkAsImportantConversationResponse = 1;
/**
 * messages.markAsRead
 *
...
export declare type MessagesMarkAsReadResponse = 1;
/**
...
export declare type MessagesMarkReactionsAsReadResponse = 0 | 1;
/**
...
export declare type MessagesMuteChatMentionsResponse = 1;
/**
 * messages.pin
 *
 * Pin a message.
...
export declare type MessagesPinResponse = MessagesPinnedMessage;
/**
...
export declare type MessagesRemoveChatUserResponse = 1;
/**
 * messages.restore
 *
...
export declare type MessagesRestoreResponse = 1;
/**
 * messages.search
 *
...
export interface MessagesSendParams {
    ...
    dont_parse_links?: 0 | 1;
    disable_mentions?: 0 | 1;
    intent?: 'account_update' | 'bot_ad_invite' | 'bot_ad_promo' | 'confirmed_notification' | 'customer_support' | 'default' | 'finance_notification' | 'game_notification' | 'moderated_newsletter' | 'non_promo_newsletter' | 'promo_newsletter' | 'purchase_update';
    subscribe_id?: number;
}
...
export declare type MessagesSendMessageEventAnswerResponse = 1;
/**
...
export declare type MessagesSendReactionResponse = 0 | 1;
/**
...
export declare type MessagesSetActivityResponse = 1;
/**
...
export declare type MessagesUnpinResponse = 1;
