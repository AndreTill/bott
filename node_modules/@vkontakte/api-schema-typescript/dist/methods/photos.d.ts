...
export declare type PhotosConfirmTagResponse = 1;
/**
 * photos.copy
 *
...
export declare type PhotosCreateAlbumResponse = PhotosPhotoAlbumFull;
/**
...
export declare type PhotosDeleteResponse = 1;
/**
 * photos.deleteAlbum
 *
...
export declare type PhotosDeleteAlbumResponse = 1;
/**
 ...
 */
export declare type PhotosDeleteCommentResponse = 0 | 1;
/**
 * photos.edit
 *
...
export declare type PhotosEditResponse = 1;
/**
 * photos.editAlbum
 *
...
export declare type PhotosEditAlbumResponse = 1;
/**
 * photos.editComment
 *
...
export declare type PhotosEditCommentResponse = 1;
/**
 * photos.get
 *
...
export declare type PhotosGetByIdResponse = PhotosPhoto[];
/**
...
export declare type PhotosGetChatUploadServerResponse = BaseUploadServer;
/**
 * photos.getComments
 *
...
export declare type PhotosGetMarketAlbumUploadServerResponse = BaseUploadServer;
/**
...
export declare type PhotosGetMessagesUploadServerResponse = PhotosPhotoUpload;
/**
 * photos.getNewTags
 *
...
export declare type PhotosGetOwnerCoverPhotoUploadServerResponse = BaseUploadServer;
/**
...
export declare type PhotosGetOwnerPhotoUploadServerResponse = BaseUploadServer;
/**
 * photos.getTags
 *
...
export declare type PhotosGetTagsResponse = PhotosPhotoTag[];
/**
...
export declare type PhotosGetUploadServerResponse = PhotosPhotoUpload;
/**
...
export declare type PhotosGetWallUploadServerResponse = PhotosPhotoUpload;
/**
 * photos.makeCover
 *
...
export declare type PhotosMakeCoverResponse = 1;
/**
 * photos.move
 *
...
export declare type PhotosMoveResponse = 1;
/**
 * photos.putTag
 *
...
export declare type PhotosRemoveTagResponse = 1;
/**
...
export declare type PhotosReorderAlbumsResponse = 1;
/**
...
export declare type PhotosReorderPhotosResponse = 1;
/**
 * photos.report
 *
...
export declare type PhotosReportResponse = 1;
/**
...
export declare type PhotosReportCommentResponse = 1;
/**
 * photos.restore
 *
...
export declare type PhotosRestoreResponse = 1;
/**
 ...
 * Returns 1 if request has been processed successfully, 0 if the comment is not found
 */
export declare type PhotosRestoreCommentResponse = 0 | 1;
/**
 * photos.save
 *
...
export declare type PhotosSaveResponse = PhotosPhoto[];
/**
...
export declare type PhotosSaveMarketAlbumPhotoResponse = PhotosPhoto[];
/**
...
export declare type PhotosSaveMessagesPhotoResponse = PhotosPhoto[];
/**
...
export declare type PhotosSaveWallPhotoResponse = PhotosPhoto[];
/**
 * photos.search
 *
