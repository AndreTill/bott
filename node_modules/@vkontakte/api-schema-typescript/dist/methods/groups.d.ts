...
export declare type GroupsAddAddressResponse = GroupsAddress;
/**
...
export declare type GroupsApproveRequestResponse = 1;
/**
 * groups.ban
 */
...
export declare type GroupsBanResponse = 1;
/**
 * groups.create
 *
...
export declare type GroupsCreateResponse = GroupsGroupFull;
/**
...
export declare type GroupsDeleteAddressResponse = 1;
/**
...
export declare type GroupsDeleteCallbackServerResponse = 1;
/**
 * groups.deleteLink
 *
...
export declare type GroupsDeleteLinkResponse = 1;
/**
...
export declare type GroupsDisableOnlineResponse = 1;
/**
 * groups.edit
 *
 * Edits a community.
...
export declare type GroupsEditResponse = 1;
/**
 * groups.editAddress
 */
...
export declare type GroupsEditAddressResponse = GroupsAddress;
/**
...
export declare type GroupsEditCallbackServerResponse = 1;
/**
 * groups.editLink
 *
...
export declare type GroupsEditLinkResponse = 1;
/**
 * groups.editManager
 *
...
export declare type GroupsEditManagerResponse = 1;
/**
 * groups.enableOnline
 */
...
export declare type GroupsEnableOnlineResponse = 1;
/**
 * groups.get
 *
...
export declare type GroupsGetCallbackSettingsResponse = GroupsCallbackSettings;
/**
...
export declare type GroupsGetLongPollServerResponse = GroupsLongPollServer;
/**
...
export declare type GroupsGetLongPollSettingsResponse = GroupsLongPollSettings;
/**
 * groups.getMembers
 *
...
export declare type GroupsGetTagListResponse = GroupsGroupTag[];
/**
...
export declare type GroupsInviteResponse = 1;
 ...
 */
export declare type GroupsIsMemberResponse = 0 | 1;
export declare type GroupsIsMemberUserIdsResponse = GroupsMemberStatus[];
...
export declare type GroupsIsMemberUserIdsExtendedResponse = GroupsMemberStatusFull[];
/**
 * groups.join
 *
...
export declare type GroupsJoinResponse = 1;
/**
 * groups.leave
 *
...
export declare type GroupsLeaveResponse = 1;
/**
 * groups.removeUser
 *
...
export declare type GroupsRemoveUserResponse = 1;
/**
 * groups.reorderLink
 *
...
export declare type GroupsReorderLinkResponse = 1;
/**
 * groups.search
 *
...
export declare type GroupsSetCallbackSettingsResponse = 1;
/**
...
export declare type GroupsSetLongPollSettingsResponse = 1;
/**
 * groups.setSettings
 */
...
export declare type GroupsSetSettingsResponse = 1;
/**
 * groups.setUserNote
 *
...
export declare type GroupsSetUserNoteResponse = 0 | 1;
/**
 * groups.tagAdd
 *
 * Add new group's tag
...
export declare type GroupsTagAddResponse = 0 | 1;
/**
 * groups.tagBind
 *
...
export declare type GroupsTagBindResponse = 0 | 1;
/**
 * groups.tagDelete
 *
 * Delete group's tag
...
export declare type GroupsTagDeleteResponse = 0 | 1;
/**
 * groups.tagUpdate
 *
 * Update group's tag
...
export declare type GroupsTagUpdateResponse = 0 | 1;
/**
 * groups.toggleMarket
 */
...
export declare type GroupsToggleMarketResponse = 1;
/**
 * groups.unban
 */
...
export declare type GroupsUnbanResponse = 1;
