...
export declare type DatabaseGetCitiesByIdResponse = DatabaseCityById[];
/**
...
export declare type DatabaseGetCountriesByIdResponse = BaseCountry[];
/**
...
export declare type DatabaseGetMetroStationsByIdResponse = DatabaseStation[];
/**
 * database.getRegions
 *
...
export declare type DatabaseGetSchoolClassesResponse = DatabaseSchoolClass[];
/**
 * database.getSchools
 *
