...
export declare type MarketAddToAlbumBaseResponse = 1;
/**
...
export declare type MarketDeleteResponse = 1;
/**
 * market.deleteAlbum
 *
...
export declare type MarketDeleteAlbumResponse = 1;
/**
 ...
 */
export declare type MarketDeleteCommentResponse = 0 | 1;
/**
...
export declare type MarketDeletePropertyResponse = 1;
/**
...
export declare type MarketDeletePropertyVariantResponse = 1;
/**
 * market.edit
 *
 * Edits an item.
...
export declare type MarketEditResponse = 1;
/**
 * market.editAlbum
 *
...
export declare type MarketEditAlbumResponse = 1;
/**
 * market.editComment
 *
...
export declare type MarketEditCommentResponse = 1;
/**
 * market.editOrder
 *
 * Edit order
...
export declare type MarketEditOrderResponse = 1;
/**
 * market.editProperty
 *
 * Adds property
...
export declare type MarketEditPropertyResponse = 1;
/**
...
export declare type MarketEditPropertyVariantResponse = 1;
/**
...
export declare type MarketGetProductPhotoUploadServerResponse = BaseUploadServer;
/**
...
export declare type MarketRemoveFromAlbumResponse = 1;
/**
...
export declare type MarketReorderAlbumsResponse = 1;
/**
 * market.reorderItems
 *
...
export declare type MarketReorderItemsResponse = 1;
/**
 * market.report
 *
...
export declare type MarketReportResponse = 1;
/**
...
export declare type MarketReportCommentResponse = 1;
/**
 * market.restore
 *
...
export declare type MarketRestoreResponse = 1;
/**
 ...
 * Returns 1 if request has been processed successfully (0 if the comment is not found)
 */
export declare type MarketRestoreCommentResponse = 0 | 1;
/**
...
export declare type MarketSaveProductPhotoBulkResponse = MarketUploadPhotoData[];
/**
 * market.search
 *
...
export declare type MarketUngroupItemsResponse = 1;
