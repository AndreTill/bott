...
export declare type SecureAddAppEventResponse = 1;
/**
 * secure.checkToken
 *
...
export declare type SecureCheckTokenResponse = SecureTokenChecked;
/**
...
export declare type SecureGetSMSHistoryResponse = SecureSmsNotification[];
/**
...
export declare type SecureGetTransactionsHistoryResponse = SecureTransaction[];
/**
 * secure.getUserLevel
 *
...
export declare type SecureGetUserLevelResponse = SecureLevel[];
/**
...
export declare type SecureSendSMSNotificationResponse = 1;
/**
 * secure.setCounter
 *
...
export declare type SecureSetCounterResponseInteger = 0 | 1;
export declare type SecureSetCounterResponseArray = SecureSetCounterItem[];
