...
export declare type AdsCheckLinkResponse = AdsLinkStatus;
/**
 * ads.createAds
 *
 * Creates ads.
...
export declare type AdsCreateAdsResponse = AdsCreateAdStatus[];
/**
 * ads.createCampaigns
 *
...
export declare type AdsCreateCampaignsResponse = AdsCreateCampaignStatus[];
/**
 * ads.createClients
 *
...
export declare type AdsCreateClientsResponse = AdsCreateClientsStatus[];
/**
...
export declare type AdsDeleteTargetGroupResponse = 1;
/**
...
export declare type AdsGetAccountsResponse = AdsAccount[];
/**
 * ads.getAds
 *
...
export declare type AdsGetAdsResponse = AdsAd[];
/**
 * ads.getAdsLayout
 *
...
export declare type AdsGetAdsLayoutResponse = AdsAdLayout[];
/**
 * ads.getAdsTargeting
 *
...
export declare type AdsGetAdsTargetingResponse = AdsTargSettings[];
/**
 * ads.getBudget
 *
...
export declare type AdsGetCampaignsResponse = AdsCampaign[];
/**
 * ads.getCategories
 *
...
export declare type AdsGetClientsResponse = AdsClient[];
/**
 * ads.getDemographics
 *
...
export declare type AdsGetDemographicsResponse = AdsDemoStats[];
/**
 * ads.getFloodStats
 *
...
export declare type AdsGetFloodStatsResponse = AdsFloodStats;
/**
...
export declare type AdsGetOfficeUsersResponse = AdsUsers[];
/**
 * ads.getPostsReach
 *
...
export declare type AdsGetPostsReachResponse = AdsPromotedPostReach[];
/**
...
export declare type AdsGetRejectionReasonResponse = AdsRejectReason;
/**
 * ads.getStatistics
 *
...
export declare type AdsGetStatisticsResponse = AdsStats[];
/**
 * ads.getSuggestions
 *
...
export interface AdsGetSuggestionsParams {
     ...
     */
    section: 'browsers' | 'cities' | 'cities_regions' | 'countries' | 'districts' | 'group_types' | 'interest_categories' | 'interest_categories_v2' | 'interests' | 'operators' | 'positions' | 'price_lists' | 'regions' | 'religions' | 'schools' | 'stations' | 'streets' | 'user_browsers' | 'user_devices' | 'user_operating_systems' | 'user_os';
    /**
...
export declare type AdsGetSuggestionsResponse = AdsTargSuggestions[];
export declare type AdsGetSuggestionsRegionsResponse = AdsTargSuggestionsRegions[];
export declare type AdsGetSuggestionsCitiesResponse = AdsTargSuggestionsCities[];
export declare type AdsGetSuggestionsSchoolsResponse = AdsTargSuggestionsSchools[];
/**
 * ads.getTargetGroups
 *
...
export declare type AdsGetTargetGroupsResponse = AdsTargetGroup[];
/**
 * ads.getTargetPixels
 */
...
export declare type AdsGetTargetPixelsResponse = AdsTargetPixelInfo[];
/**
...
export declare type AdsGetTargetingStatsResponse = AdsTargStats;
/**
 * ads.getUploadURL
 *
...
export declare const AdsRemoveTargetContactsResponseResultEnumNames: {
    readonly OK: 1;
};
...
export declare type AdsUpdateAdsResponse = AdsUpdateAdsStatus[];
/**
 * ads.updateCampaigns
 *
...
export declare type AdsUpdateCampaignsResponse = AdsCreateCampaignStatus[];
/**
 * ads.updateClients
 *
...
export declare type AdsUpdateClientsResponse = AdsUpdateClientsStatus[];
/**
...
export declare type AdsUpdateTargetGroupResponse = 1;
/**
