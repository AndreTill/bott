 ...
 * Result
 */
export declare type PollsAddVoteResponse = 0 | 1;
/**
 * polls.create
 *
...
export declare type PollsCreateResponse = PollsPoll;
/**
 * polls.deleteVote
 *
 ...
 * Result
 */
export declare type PollsDeleteVoteResponse = 0 | 1;
/**
 * polls.edit
 *
 * Edits created polls
...
export declare type PollsEditResponse = 1;
/**
 * polls.getBackgrounds
 */
export interface PollsGetBackgroundsParams {
}
export declare type PollsGetBackgroundsResponse = PollsBackground[];
/**
 * polls.getById
 *
...
export declare type PollsGetByIdResponse = PollsPollExtended;
/**
...
export declare type PollsGetPhotoUploadServerResponse = BaseUploadServer;
/**
 * polls.getVoters
 *
...
export declare type PollsGetVotersResponse = PollsVoters[];
export declare type PollsGetVotersFieldsResponse = PollsFieldsVoters[];
/**
 * polls.savePhoto
 */
...
export declare type PollsSavePhotoResponse = PollsBackground;
