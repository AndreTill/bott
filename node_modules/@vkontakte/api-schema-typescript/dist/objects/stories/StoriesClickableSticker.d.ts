...
export interface StoriesClickableSticker {
    ...
    style?: 'transparent' | 'blue_gradient' | 'red_gradient' | 'underline' | 'blue' | 'green' | 'white' | 'question_reply' | 'light' | 'impressive' | 'dark' | 'accent_background' | 'accent_text' | 'dark_unique' | 'light_unique' | 'light_text' | 'dark_text' | 'black' | 'dark_without_bg' | 'light_without_bg' | 'rectangle' | 'circle' | 'poop' | 'heart' | 'star' | 'album' | 'horizontal' | 'equalizer' | 'header_meta' | 'preview' | 'miniature' | 'fullview' | 'cta' | 'sticker' | 'sticker_and_cta' | 'accent';
    type?: 'hashtag' | 'mention' | 'link' | 'question' | 'place' | 'market_item' | 'music' | 'story_reply' | 'owner' | 'post' | 'poll' | 'sticker' | 'app' | 'situational_theme' | 'playlist' | 'clip' | 'vk_video' | 'situational_template' | 'spoiler' | 'service_yc_item';
